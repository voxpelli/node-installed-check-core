...
/** @typedef {string | typeof ROOT} WorkspaceKey */

/** @typedef {Partial<Record<WorkspaceKey, boolean>>} WorkspaceSuccess */
...
/**
 * @param {Map<WorkspaceKey, string[]>} notes
 * @param {LookupOptions} [lookupOptions]
 * @returns {string[]}
 */
